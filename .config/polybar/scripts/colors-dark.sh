...
sed -i -e 's/bground = .*/bground = #1e1e1e/g' $PDIR/config.ini
...
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/shade2 = .*/shade2 = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/shade3 = .*/shade3 = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/shade4 = .*/shade4 = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/shade5 = .*/shade5 = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/shade6 = .*/shade6 = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/shade7 = .*/shade7 = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/shade8 = .*/shade8 = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/accent = .*/accent = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/bground = .*/bground = #1e1e1e/g' $PDIR/config.ini
sed -i -e 's/modulefg-alt = .*/modulefg-alt = #f7f7f7/g' $PDIR/config.ini
# Restarting polybar
$LAUNCH &
